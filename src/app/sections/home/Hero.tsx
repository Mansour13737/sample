...
export default function Hero() {
    return (
        <div className="bg-center bg-cover bg-[url('/images/hero/hero-bg.png')] h-[100vh] p-b-3 flex flex-col lg:justify-between justify-strat items-center mx-auto">
            <Header />
            <div className="flex justify-between w-screen">
                <div className="container flex flex-col items-start lg:mt-[39px] mt-[240px] lg:p-y-0 mx-auto">
                    ...
                    <div className="mt-10 block lg:justify-between lg:items-center lg:flex lg:gap-[13px]">
                        ...
                        <Button chld={"join the waitlist"} className="px-5 lg:w-[150px] lg:h-[48px] w-screen bg-gradient-to-t mt-[13px] lg:mt-0 from-[#025099] to-[#0385FF] text-[14px] font-semibold text-white rounded-[8px] pt-[14px] pb-[15px]"/>
                    </div>
                </div>
